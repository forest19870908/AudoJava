...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="NOReceivableWarn";
	public static String note="未收款提醒监控 数据细分粒度：每个销售合同的每次出库 数据展示范围，所有业务的所有未收款，含部分暂估应收和全部应收";//注释
